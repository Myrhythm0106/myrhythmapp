...
| Founding pain | Routes that solve it | Cost avoided |
|---|---|---|
| Lost conversations | Capture, Memory Bridge | £40–£80/hr scribe or repeat appointment |
| Dropped actions | Commit, Calendar | Missed appointments, lost work hours |
| Energy-blind scheduling | Calibrate, Calendar | 2–3 recovery days per over-scheduled day |
| Isolated caregiving | Support Circle, Memory Bridge | Caregiver burnout, repeat-explanation fatigue |
| Trust deficit | Settings, Profile, Edition page | Churn in week two |
