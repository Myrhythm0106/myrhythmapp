...
**Who this is for.** MyRhythm exists to fix three failures: the **Discharge Cliff** (support disappears at discharge), the **Clinical-Ready vs Life-Ready Gap** (a discharge letter is not a life-readiness certificate), and the **Ideal-Brain Assumption** — the design flaw in mainstream productivity tools that assumes brains that never forget, fatigue, or overwhelm. That third problem covers adults with ADHD, families navigating dementia/MCI, stressed/burnt-out workers, and knowledge workers losing hours a day to distraction. Every feature you test carries a **4R tag** — **Remove / Reduce / Return / Reconnect** — where **Reconnect** is Support Circle's home ("No one walks alone"). Full stats and citations: `mem://brand/third-problem-ideal-brain` and `docs/myrhythm-one-page-pitch.md`.
