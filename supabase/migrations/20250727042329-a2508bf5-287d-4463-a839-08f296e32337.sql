...
ALTER TABLE public.daily_actions ALTER COLUMN watchers DROP DEFAULT;
ALTER TABLE public.daily_actions ALTER COLUMN watchers TYPE UUID[] USING '{}';
ALTER TABLE public.daily_actions ALTER COLUMN watchers SET DEFAULT '{}';
