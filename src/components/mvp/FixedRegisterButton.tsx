...
import { InitialRegistrationModal } from './InitialRegistrationModal';
...
export function FixedRegisterButton() {
  ...
  const handleRegistrationComplete = (userData: { fullName: string; email: string }) => {
    // Navigate to plan selection with user data
    navigate('/mvp/plan-selection', { state: { userData } });
  };
