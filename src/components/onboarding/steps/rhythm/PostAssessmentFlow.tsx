...
import { Timer, Crown, Star, Zap, ArrowRight } from "lucide-react";
...
export function PostAssessmentFlow({ assessmentResult, onComplete }: PostAssessmentFlowProps) {
  ...
  // Simplified conversion banner - less aggressive
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 relative">
      ...
      {/* Bottom conversion bar - simplified */}
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-teal-200 p-4 z-30">
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-slate-900">Unlock Your Complete Journey</p>
