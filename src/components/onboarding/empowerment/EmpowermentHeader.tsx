...
export function EmpowermentHeader({ currentStep, totalSteps }: EmpowermentHeaderProps) {
  return (
    <div className="text-center space-y-4 bg-gradient-to-br from-purple-50/30 via-blue-50/20 to-teal-50/30 p-4 rounded-lg">
      <div className="flex items-center justify-center gap-3">
        <div className="w-12 h-12 bg-gradient-to-br from-purple-600 via-blue-600 to-teal-600 rounded-xl flex items-center justify-center shadow-lg">
