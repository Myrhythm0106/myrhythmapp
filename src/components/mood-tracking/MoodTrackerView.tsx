...
import { Smile, Clock, Calendar, Share2 } from "lucide-react";
...
export function MoodTrackerView() {
  ...
  // Function to share mood data with support circle
  const handleShareWithSupport = () => {
    toast.success("Mood data shared with your support circle", {
      description: "They will be able to view your mood trends."
    });
  };
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button 
          ...
          onClick={handleShareWithSupport}
        >
      ...
      <Tabs value={selectedView} onValueChange={setSelectedView}>
        ...
        <TabsContent value="week">
          <Card>
            ...
            <CardContent>
              <MoodHistoryChart data={getChartData(filteredEntries)} />
