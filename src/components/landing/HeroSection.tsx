    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-blue-50 to-indigo-50 py-24 md:py-32">
      ...
      <div className="container mx-auto px-4 max-w-5xl text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed">
          Navigating life after a brain injury or any condition that impacts your memory is a unique journey of rediscovery. 
          It's about finding your own way forward, at your own pace. We believe in empowering you with simple, actionable 
          steps to build confidence and create a life that feels right for you.
        </p>
