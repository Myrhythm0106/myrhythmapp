      ...
      <div className="bg-gradient-to-r from-primary/10 to-secondary/10 py-20 md:py-32">
        <div className="container mx-auto px-4 max-w-6xl relative">
          ...
          <div className="text-center mb-12 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">Empowering you to live O.R.D.E.R.ly. Organize priorities, build Routines, strengthen Discipline, Execute with focus, and Review with intention. 
It's not just productivity.
It's your rhythm for life.</p>
