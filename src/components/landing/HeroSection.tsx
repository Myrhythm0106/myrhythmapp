  ...
  return <section className="relative overflow-hidden bg-gradient-to-r from-blue-50 to-indigo-50 py-24 md:py-32">
      ...
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <div className="space-y-6 mb-10">
          <p className="text-xl max-w-3xl mx-auto leading-relaxed text-annabel-600 md:text-2xl font-medium">Your Life Empowering And Productivity tool that moves you forward.  Its time for you to LEAP with MyRhythm!</p>
