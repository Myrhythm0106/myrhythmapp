...
export function MyRhythmIntro() {
  ...
  return (
    <section id="myrhythm-framework" className="py-16 bg-gradient-to-b from-white to-brain-health-50">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-brain-health-800 flex items-center justify-center gap-2">
            <Star className="h-8 w-8 text-memory-emerald-600" />
            The MyRhythm Framework
          </h2>
          <p className="text-lg text-brain-health-600 max-w-2xl mx-auto">
            An evidence-based 8-step system crafted from lived experience to help you reclaim your rhythm and thrive.
          </p>
        </div>
        
        <div className="grid gap-8 md:grid-cols-2 mb-12">
          <Card className="border-brain-health-200 bg-gradient-to-br from-brain-health-50 to-memory-emerald-50">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="bg-brain-health-100 p-2 rounded-full">
                  <Brain className="h-6 w-6 text-brain-health-600" />
                </div>
                <h3 className="text-xl font-semibold text-brain-health-800">Born from Experience</h3>
              </div>
          ...
          <Card className="border-memory-emerald-200 bg-gradient-to-br from-memory-emerald-50 to-clarity-teal-50">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="bg-memory-emerald-100 p-2 rounded-full">
                  <Heart className="h-6 w-6 text-memory-emerald-600" />
                </div>
                <h3 className="text-xl font-semibold text-memory-emerald-800">Your Personal Guide</h3>
              </div>
              <p className="text-memory-emerald-600 leading-relaxed">
        ...
        <div className="bg-gradient-to-r from-brain-health-100 to-memory-emerald-100 rounded-xl p-8 text-center mb-8">
          <h3 className="text-xl font-bold mb-4 text-brain-health-800">The 8 Steps of MyRhythm</h3>
          <div className="grid grid-cols-4 md:grid-cols-8 gap-4 mb-6">
            {['M', 'Y', 'R', 'H', 'Y', 'T', 'H', 'M'].map((letter, index) => (
              <div key={index} className="w-12 h-12 bg-gradient-to-r from-brain-health-600 to-memory-emerald-600 text-white rounded-full flex items-center justify-center font-bold">
                {letter}
              </div>
            ))}
          </div>
        ...
        <Card className="border-brain-health-200 bg-white/80 backdrop-blur-sm">
          <CardContent className="p-6">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="framework-details">
                <AccordionTrigger className="text-lg font-semibold text-brain-health-700 hover:text-brain-health-600">
                  ...
                  <div className="space-y-6 pt-4">
                    ...
                    <div className="grid gap-6">
                      {frameworkSteps.map((step, index) => (
                        <div key={index} className="flex gap-4 p-4 bg-gradient-to-r from-brain-health-50 to-memory-emerald-50 rounded-lg">
                          <div className="flex-shrink-0">
                            <div className="w-12 h-12 bg-gradient-to-r from-brain-health-600 to-memory-emerald-600 text-white rounded-full flex items-center justify-center font-bold text-lg">
                              {step.letter}
                            </div>
                          </div>
                          <div className="flex-1">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                              <h4 className="font-bold text-lg text-brain-health-800">{step.word}</h4>
                              <span className="text-sm text-memory-emerald-600 font-medium">• {step.phase}</span>
                            </div>
                            <p className="text-brain-health-600 leading-relaxed">
                              {step.description}
                            </p>
                    ...
                    <div className="mt-8 p-4 bg-gradient-to-r from-brain-health-50 to-memory-emerald-50 rounded-lg border border-brain-health-200">
                      <p className="text-sm text-brain-health-600 italic text-center">
