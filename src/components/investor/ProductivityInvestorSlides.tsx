      ...
      <div className="flex-1 flex flex-col justify-center px-[160px]">
        ...
        <div className="mt-[28px] flex gap-[20px]">
          {[
            ...
            { pillar: "Management", desc: "Assistant-First auto-scheduling with edit, deny, and contact list — users adjust times, dismiss suggestions, or add any email with smart typeahead from saved contacts and Support Circle", color: "#f97316" },
          ].map((p) => (
    ...
    <Slide>
      <div className="flex-1 flex flex-col justify-center px-[120px]">
        ...
        <div className="mt-[12px] text-[14px] text-center" style={{ color: "#94a3b8" }}>
          MyRhythm is a Cognitive Operating System (LEAP-OS). It is not a medical device.
        </div>
      </div>
    </Slide>
  );
