...
import { LifeRhythmScore } from "./LifeRhythmScore";
import { MemoryWinsShowcase } from "./MemoryWinsShowcase";
            ...
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <div className="text-left">
                <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 via-blue-600 to-teal-600 bg-clip-text text-transparent">
                  Welcome to Memory1st, {displayName}
                </h1>
                <p className="text-lg text-gray-600">Your personal rhythm for brain health recovery</p>
              </div>
            </div>
            <Badge variant="outline" className="bg-gradient-to-r from-purple-50 to-blue-50 text-purple-700 border-purple-200 px-4 py-1">
              🎵 Day {todayStats.streakDays} of Your Recovery Symphony
            </Badge>
          </div>

          {/* Daily Motivation - Prominent Position */}
          <MemoryFirstMotivation 
                ...
                <CardContent className="space-y-4">
                  <div className="bg-white/80 p-4 rounded-lg border border-blue-100">
                    <h3 className="font-semibold text-blue-800 mb-2 flex items-center gap-2">
                      ...
                      Strengthen Your Daily Rhythm
                    </h3>
                    <p className="text-sm text-gray-600 mb-3">
                      Consistency creates neural pathways. Today's focus: building your memory muscle through repetition.
                    </p>
                ...
                <CardContent className="space-y-3">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-3 bg-white/80 rounded-lg">
                      ...
                      <span className="text-sm flex-1">Morning brain boost</span>
                    ...
                    <div className="flex items-center gap-2 p-3 bg-white/80 rounded-lg">
                      ...
                      <span className="text-sm flex-1">Memory training session</span>
                    ...
                    <div className="flex items-center gap-2 p-3 bg-white/80 rounded-lg">
                      ...
                      <span className="text-sm flex-1">Evening reflection</span>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    >
                      ...
                      <span className="text-xs font-medium">Brain Games</span>
                    </Button>
                    <Button 
                      variant="outline" 
          ...
          <div className="text-center py-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-blue-100 rounded-full">
              ...
              <span className="text-sm font-medium bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                Every day you're composing your recovery masterpiece 🎼
              </span>
            </div>
          </div>
        </div>
