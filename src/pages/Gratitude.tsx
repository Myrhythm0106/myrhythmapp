...
const Gratitude = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      ...
      <Card className="bg-gradient-to-br from-blue-50 via-purple-50 to-rose-50 border-blue-200 mb-8 shadow-lg">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="add-gratitude" className="space-y-6">
