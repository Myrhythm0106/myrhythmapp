      ...
      <ScrollArea className="h-screen">
        <div className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">MyRythmn empowers you to live O.R.D.E.R.ly.  Organise your priorities, build a Routine, strengthen your Discipline, Execute with focus, and Review with intention.  It's more than productivity, it's your rhythm for life!</p>
          </div>
