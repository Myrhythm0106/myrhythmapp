    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-teal-50">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          {isFoundingActive && (
            <div className="bg-gradient-to-r from-amber-100 to-orange-100 border border-amber-300 rounded-lg p-4 mb-6 max-w-md mx-auto">
          ...
          <div className="inline-flex items-center gap-4 p-2 bg-white rounded-xl border border-slate-200 shadow-sm">
            <button
              ...
              className={cn(
                ...
                !isYearly ? "bg-teal-600 text-white shadow-sm" : "text-slate-600 hover:text-slate-900"
              )}
            >
              Monthly
            </button>
