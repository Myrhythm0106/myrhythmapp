...
import DevCardsPreview from "@/pages/DevCardsPreview";
    ...
    <ErrorBoundary>
     ...
     {/* Landing and Discovery Routes */}
      ...
      <Route path="/welcome" element={<ProtectedRoute requireAuth={false}><Welcome /></ProtectedRoute>} />
                    ...
                    <Route path="/memorybridge" element={<Navigate to="/launch/memory" replace />} />
                    <Route path="/memory" element={<Navigate to="/launch/memory" replace />} />
